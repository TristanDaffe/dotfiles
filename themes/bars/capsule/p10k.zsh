# Capsule powerline — Powerlevel10k geometry
#
...
# ~/.p10k.zsh, so these win. Switch with `bar-set capsule`.
#
# Rounded caps at both ends of each prompt line, solid arrows between
# segments — the prompt equivalent of the floating pills in the capsule bar.
